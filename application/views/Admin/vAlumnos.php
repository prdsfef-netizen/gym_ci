        ...
        <div class="row">
                    ...
                    <div class="col-md-6 col-sm-4 clearfix hidden-xs">
                        ...
                        <ul class="list-inline links-list pull-right">
                           ...
                           <li>Bienvenido <?php echo $this->session->userdata('usuario');?> </li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <div class="btn-group">
                                                       ...
                                                       <a href="<?php echo base_url();?>cActiv">
                                                     <i class="entypo-pencil"></i><span>Editar</span>
                                                       </a>   
                                                       <a href="<?php echo base_url();?>ccActiv">
                                                      <i class="entypo-trash"><span>Borrar</span></i>
                                                       </a>   
