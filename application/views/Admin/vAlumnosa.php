...
<body class="page-body  page-fade">
 ...
 <?php if(!empty($alumno)):?>
                                            ...
                                            <td>
                                               <div class="btn-group">
                                                   <li>
                                                       ...
                                                       <button type="button" class="btn btn-success">Detener</button>
                                                       </a>   
                                                     </li>
    ...
    <script src="http://localhost/gym/http://localhost/gym/neon/js/neon-api.js" id="script-resource-6"></script>
    <script src="http://localhost/gym/neon/js/jquery.validate.min.js" id="script-resource-7"></script>
    <script src="http://localhost/gym/http://localhost/gym/neon/js/neon-login.js" id="script-resource-8"></script>
  ...
  <link rel="stylesheet" href="http://localhost/gym/http://localhost/gym/neon/js/select2/select2-bootstrap.css"  id="style-resource-1">
